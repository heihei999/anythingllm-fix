...
export default function ChatContainer({
  ...
  useEffect(() => {
    ...
    async function fetchReply() {
      ...
      const promptMessage =
        _chatHistory.length > 0 ? _chatHistory[_chatHistory.length - 1] : null;
      const remHistory = _chatHistory.length > 0 ? _chatHistory.slice(0, -1) : [];
      var _chatHistoryArr = [...remHistory];
      ...
      cacheStreamingHistory(workspace.slug, threadSlug, _chatHistoryArr);
